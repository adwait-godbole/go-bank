...
// Source: github.com/adwait-godbole/go-bank/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) CreateVerificationEmail(ctx context.Context, arg db.CreateVerificationEmailParams) (db.VerificationEmail, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateVerificationEmail", ctx, arg)
...
func (mr *MockStoreMockRecorder) CreateVerificationEmail(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateVerificationEmail", reflect.TypeOf((*MockStore)(nil).CreateVerificationEmail), ctx, arg)
}
...
// GetAccountForNoKeyUpdate mocks base method.
func (m *MockStore) GetAccountForNoKeyUpdate(ctx context.Context, id int64) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccountForNoKeyUpdate", ctx, id)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAccountForNoKeyUpdate indicates an expected call of GetAccountForNoKeyUpdate.
func (mr *MockStoreMockRecorder) GetAccountForNoKeyUpdate(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccountForNoKeyUpdate", reflect.TypeOf((*MockStore)(nil).GetAccountForNoKeyUpdate), ctx, id)
}
